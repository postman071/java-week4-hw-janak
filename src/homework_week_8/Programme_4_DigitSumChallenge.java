 ...
 * The numbers from 0-9 have 1 digit so we don't want to process them; alo we don't want to process negative numbers,
 * so also return -1 fr negative numbers.
 * For example calling the method sumDigits (125) should return 8 since 1 + 2 + 5 =8'
 * calling the method sumDigits(!) should return -1 as per requirements described above.
